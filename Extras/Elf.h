...
#pragma pack(pop)
    ...
    struct MOKLIB_API ReadContext {
        ...
        using EnumerateSectionsDelegate =
            Delegate<EnumerateSectionsAnswer, SecHeader64*, u16>;
        ...
        SecHeader64* get_section_header(
            Str name, Allocator& allocator = System_Allocator);
    };

    MOKLIB_API Result<ReadContext, Str> open(
        Tape* tape, Allocator& allocator = System_Allocator);
