...
public:
    ...
    u32 set_timer(
        TimeSpec interval, bool repeat, Callback callback, u32 id = 0);

    u32 set_timer(
        float interval_sec, bool repeat, Callback callback, u32 id = 0)
    {
    ...
    void init(Allocator& allocator = System_Allocator);
    void update();
